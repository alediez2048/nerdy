...
class TestVideoPipelineCopyGeneration:
    ...
    @patch("generate_video.orchestrator.score_and_select_video_variants")
    ...
    def test_video_pipeline_generates_copy_before_spec(
        ...
        mock_score_and_select: MagicMock,
        ...
        mock_score_and_select.return_value = None
    ...
    # PI-10: test_video_pipeline_passes_variant_type_into_evaluators
    # removed — exercised the retired evaluate_video_attributes +
    # check_video_coherence + select_best_video path. The replacement
    # path (score_and_select_video_variants → evaluate_media) is
    # covered by tests/test_pipeline/test_video_pipeline_pi06.py.
