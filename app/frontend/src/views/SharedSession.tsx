...
export default function SharedSession() {
  ...
  if (!data) return <div style={s.page}><p style={{ color: colors.muted }}>Loading...</p></div>
...
const s: Record<string, React.CSSProperties> = {
  page: { minHeight: '100vh', background: colors.ink, fontFamily: font.family, padding: '32px 20px', maxWidth: '800px', margin: '0 auto' },
  banner: {
